...
namespace MatchZy
{
    public partial class MatchZy
    {
        ...
        public bool LoadMatchFromJSON(string jsonData)
        {
            ...
            {
                liveMatchId = (string)jsonDataObject["matchId"]!;
            }
        ...
        public void GetOptionalMatchValues(JObject jsonDataObject)
        {
            ...
            if (jsonDataObject["remoteLogUrl"] != null)
            {
                string url = jsonDataObject["remoteLogUrl"]!.ToString().Trim();
                if (!string.IsNullOrEmpty(url))
                {
                    matchConfig.RemoteLogURL = url;
                    Log("Remote log URL was set.");
                }
            }
